...
public class Auction implements Serializable {
    ...
    public Auction(String id, Item item, LocalDateTime startTime,
                   LocalDateTime endTime, String status, BidRecord highestBid) {
        this.id = id;
        this.item = item;
    ...
    public BidRecord getHighestBid() { return highestBid; }
    ...
    public void setHighestBid(BidRecord highestBid) { this.highestBid = highestBid; }
}
